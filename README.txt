...
Функционал:
back-end Функционал Организации:
...
front-end: 4 вкладки: список организаций, список сотрудников, дерево организаций, дерево сотрудников В зависимости от вкладки список организаций или список сотрудников осуществляется переход по кнопке создать на необходимую форму.

Применить при реализации:
spring boot 2
postgres
для доступа к db использовать jooq
использовать транзакции где необходимо
использовать connection pool для db
использовать angularjs 1
собирать фронт с помощью webpack
желательно придерживаться стандартов es6
код тестового задания необходимо разместить на github , в readme должна быть инструкция по запуску